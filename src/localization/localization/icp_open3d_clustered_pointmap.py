#!/usr/bin/env python3
"""
Standalone ROS 2 node for 2D LaserScan scan-to-map point-cloud ICP using Open3D, with significant-cluster filtering.
...
class Open3DClusteredPointMapLocalization(Node):
    def __init__(self) -> None:
        super().__init__("open3d_clustered_pointmap_localization")
        ...
        self.get_logger().info(
            "Open3D clustered point-map localization started | "
