...
class Open3DClusteredPointMapLocalization(Node):
    def __init__(self) -> None:
        super().__init__("open3d_clustered_novel_pointmap_localization")
        ...
        self.declare_parameter("range_max_clip", 5.5)
        ...
        self.declare_parameter("cluster_max_mean_range", 5.5)
        ...
        # Open3D ICP
        self.declare_parameter("open3d_max_corr_dist", 0.22)
        ...
        self.declare_parameter("open3d_min_fitness", 0.35)
        self.declare_parameter("open3d_max_rmse", 0.12)
        self.declare_parameter("icp_accept_max_translation", 0.22)
        self.declare_parameter("icp_accept_max_rotation_deg", 4.5)
        self.declare_parameter("pose_smoothing_alpha", 0.02)
        ...
        # Novel-point insertion. When enabled, map updates only insert points
        # that are far enough from the existing map. This prevents thick/ghost
        # walls while still allowing genuinely new areas to grow the map.
        self.declare_parameter("insert_only_novel_points", True)
        self.declare_parameter("novel_point_min_dist", 0.18)
        self.declare_parameter("novel_point_max_dist", 5.5)
        self.declare_parameter("novel_min_points", 25)

        # ICP-corrected map update gate
        self.declare_parameter("map_update_min_translation", 0.30)
        self.declare_parameter("map_update_min_rotation_deg", 10.0)
        self.declare_parameter("map_update_min_fitness", 0.80)
        self.declare_parameter("map_update_max_rmse", 0.055)
        self.declare_parameter("map_update_max_correction_translation", 0.05)
        self.declare_parameter("map_update_max_correction_rotation_deg", 1.5)

        # Odom-only map update fallback
        self.declare_parameter("allow_odom_map_update_when_icp_rejected", True)
        self.declare_parameter("odom_map_update_min_translation", 0.40)
        self.declare_parameter("odom_map_update_min_rotation_deg", 14.0)
        self.declare_parameter("odom_map_update_max_fitness", 0.03)
        ...
        self.get_logger().info(
            "Open3D clustered novel-point-map localization started | "
