...
class Detection(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("max_general_counter", 2000)
        ...
        self.point_buffers = {'red': [], 'green':[], 'blue': [], 'box':[]}
    ...
    def cloud_callback(self, msg: PointCloud2):
        ...
        red_mask, green_mask, blue_mask, box_mask = self.get_masks(colors_f, colors_f_box) # returns the color masks based on threshold values
        ...
        general_counter = red_counter + green_counter + blue_counter + box_counter
    ...
    def get_masks(self, colors, colors_box):
        ...
        box_mask = (            
            (self.thresh[3, 0] < colors_oklab_box[:, 1]) & (colors_oklab_box[:, 1] < self.thresh[3, 1]) & 
            (self.thresh[3, 2] < colors_oklab_box[:, 2]) & (colors_oklab_box[:, 2] < self.thresh[3, 3]) & 
            (self.thresh[3, 4] < colors_oklab_box[:, 0]) & (colors_oklab_box[:, 0] < self.thresh[3, 5])
            )
        
        return red_mask, green_mask, blue_mask, box_mask
    ...
    def get_thresholds(self):
        ...
        thresh_box_b_high = comp_colors_oklab[3,2] + tol_box
