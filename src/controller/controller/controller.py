...
class Controller(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('nominal_linear_speed', 0.45)    # default slower for path tracking 0.25
        self.declare_parameter('max_angular_speed', 0.19)        # cap turning a bit more conservatively 0.15
